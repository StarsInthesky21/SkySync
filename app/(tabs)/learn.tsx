  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        <SectionHeader title="Daily Challenges" subtitle={`${app.challengeProgress.completedIds.length}/${app.dailyChallenges.length} completed today`} />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.factCard}>
            ...
            <Text style={styles.factText}>Sirius, the brightest star in the night sky, is actually a binary system - it has a tiny white dwarf companion called Sirius B.</Text>
          </View>
          <View style={[styles.factCard, { borderBottomWidth: 0 }]}>
            <Text style={styles.factEmoji}>{"\u{1F315}"}</Text>
            <Text style={styles.factText}>The same side of the Moon always faces Earth due to tidal locking. We've never seen the far side with our naked eyes.</Text>
          </View>
        </View>
      </ScrollView>
