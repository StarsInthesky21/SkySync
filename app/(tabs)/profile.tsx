  ...
  if (showAuth) {
    return (
      <SafeAreaView style={styles.safe}>
        <AuthScreen initialMode={showAuth} onClose={() => setShowAuth(null)} />
      </SafeAreaView>
    );
  }
