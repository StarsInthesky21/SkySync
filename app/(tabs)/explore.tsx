...
export default function ExploreScreen() {
  ...
  ), [app.focusObject, app.toast, router]);
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        <SectionErrorBoundary section="Guided Mode">
          <View style={styles.card}>
            <FlatList data={app.guidedTargets} renderItem={renderGuided} keyExtractor={(i) => i.id} scrollEnabled={false} />
          </View>
      ...
      <ObjectDetailModal
        ...
        onFocus={() => { if (app.object) app.focusObject(app.object.id); app.selectObject(undefined); router.navigate("/(tabs)"); }}
      />
    </SafeAreaView>
  );
}
