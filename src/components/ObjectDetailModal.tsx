            ...
            <Pressable onPress={() => {}} style={{ flex: 1 }}>
              <ScrollView contentContainerStyle={styles.modalContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.modalHeader}>
                  ...
                  <Pressable style={({ pressed }) => [styles.shareChip, pressed && { opacity: 0.7 }]} onPress={onShare}>
                ...
                {selectedObject?.scientificFacts.map((f, i) => (
                  <Text key={`f-${i}`} style={styles.fact}>- {f}</Text>
                ))}
                ...
                <View style={styles.btnRow}>
                  <Pressable
                    ...
                    accessibilityLabel={selectedObject && highlightedIds.includes(selectedObject.id) ? "Remove highlight from this object" : "Highlight this object for room members"}
                  >
